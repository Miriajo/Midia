...
class MovieTests: XCTestCase {
    ...
    var bestMovie: Movie = Movie(movieId: "1", title: "Top Gun - Ídolos del aire", directors: ["Tony Scott"], releaseDate: Date(timeIntervalSinceNow: 13213), synopsis: "Una hábil conbinación de acción, música e increíble fotografía aérea, hicieron de Top Gun Ídolos del Aire el gran éxito de 1986. Se trata de una apasionante mirada a los peligros y emociones que esperan a cada piloto de una prestigiosa academia de aviación del ejército. Tom Cruise ofrece una soberbia actuación como Maverick Mitchell, un joven y arriesgado piloto destinado a convertirse en el mejor, y Kelly McGillis resulta brillante como la profesora civil que enseña a Maverick algunas cosas que no se pueden aprender en clase.", posterURL: URL(string: "https://is4-ssl.mzstatic.com/image/thumb/Video/v4/87/53/17/8753170e-df31-8d20-39c2-525e9ce0f3d6/source/100x100bb.jpg"), rating: nil, numberOfReviews: nil, price: 9)
    ...
    func testDecodeMovieCollection() {
        ...
        do {
            ...
            let firstMovie = movieCollection.items?.first!
